...
if contact_or_dist_or_binned == 'contact':
    train_generator = ContactGenerator(train_pdbs, dir_dataset + '/ssd2tb/covnpre/', dir_dataset + '/deepcov/distance/', training_window, pad_size, batch_size)
    ...
    valid_generator = ContactGenerator(valid_pdbs, dir_dataset + '/ssd2tb/covnpre/', dir_dataset + '/deepcov/distance/', training_window, pad_size, batch_size)
...
if contact_or_dist_or_binned == 'contact':
    ...
    model.load_weights(file_weights)
    eval_contact_predictions(model, valid_pdbs, length_dict, dir_dataset + '/ssd2tb/covnpre/', dir_dataset + '/deepcov/distance/', pad_size, flag_plots, False, LMAX)
